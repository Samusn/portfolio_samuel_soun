export function SiteFooter() {
  return (
    <footer className="border-t border-slate-200 bg-slate-50 px-4 py-6 text-xs text-slate-600 sm:px-6 lg:px-12 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-400">
